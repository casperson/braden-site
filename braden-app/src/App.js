...
import profilePhoto from './images/website-photo-me-2.png';
        ...
        <div className="App-container">
          ...
          <div className="App-text-container">
            ...
            <p className="App-intro">
              I'm an engineer who does iOS work @GapInc. Check out my blog below. Feel free to contact me.
            </p>
            <p className="App-links">
              ...
              <a href="https://thecodingway.tumblr.com" target="_blank"><i className="fa fa-tumblr fa-2x" aria-hidden="true"></i></a>
            </p>
          </div>
        </div>
      </div>
